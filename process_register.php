...
if ($_SERVER ["REQUEST_METHOD"] == "POST") 
 ...
 // Criptografa a senha de salvar banco de dados
 // password_hash() é uma função segura que utiliza o algoritmo brypt por padrão
  $senha = password_hash ($_POST['senha' ], PASSWORD_DEFAULT);
  
  // Prepara a quey SQL  com parâmetros (?) para evitar SQL Injection
